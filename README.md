...
We decided to run together for this post because teamwork makes the dream work. We feel strongly that our unique contributions to organising the OSR will produce a more productive, inspiring and inclusive space, and we want to show you how well the core tenant of collaboration in open science can work in practice. We'll learn from each other along the way, and produce something beautiful.
